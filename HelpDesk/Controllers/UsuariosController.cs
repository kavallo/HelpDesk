...
namespace HelpDesk.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UsuarioID,Usuario1,Clave,FechaUltimoAcceso,EstatusID")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UsuarioID,Usuario1,Clave,FechaUltimoAcceso,EstatusID")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
